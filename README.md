...
გამოწვევა: ამოღებული ტექსტი იყო არეული, აკლდა მკაფიო გამყოფები და ჰქონდა არათანმიმდევრული ფორმატირება (განსაკუთრებით ფინიშზე გასული და დისკვალიფიცირებული მრბოლელებისთვის).

2. მონაცემთა გაწმენდა და ტრანსფორმაცია
მიზანი: არეული ტექსტის სტრუქტურირებულ, რიცხვით ცხრილად გადაქცევა.
ინსტრუმენტები: re და pandas ბიბლიოთეკები.
პროცესი:
...
Diff (განსხვავება) სვეტი კონვერტირდა რიცხვით ტიპად, არარიცხობრივი ჩანაწერებით ("8 Laps"-ის მსგავსად) გადაკეთდა NaN-ად, რათა მონაცემები მომზადებულიყო გრაფიკისთვის.
